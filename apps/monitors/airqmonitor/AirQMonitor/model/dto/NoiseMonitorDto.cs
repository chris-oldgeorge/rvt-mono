...
public class NoiseMonitorStatus(DateTime updateTime, string status, int errorCount, string? batteryVoltage,
                          DateTime? calibrationDate, DateTime? filterChangeDate, string? pumpHours)
{
    ...
    public string? BatteryVoltage { get; } = batteryVoltage;
    public DateTime? CalibrationDate { get; } = calibrationDate;
    public DateTime? FilterChangeDate { get; } = filterChangeDate;
    public string? PumpHours { get; } = pumpHours;
