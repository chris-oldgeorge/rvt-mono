...
{
    private readonly StoreMonitorsHandler _storeMonitors = storeMonitors;
    private readonly CheckForOfflineMonitorsHandler _checkForOfflineMonitors = checkForOfflineMonitors;
    private readonly StoreDustLevelsHandler _storeDustLevels = storeDustLevels;
    private readonly ProcessDustLevelsHandler _processDustLevels = processDustLevels;
    private readonly ClearOlderErrorMessagesHandler _clearOlderErrorMessages = clearOlderErrorMessages;
    private readonly StoreAccessoryInfoHandler _storeAccessoryInfo = storeAccessoryInfo;
    private readonly MonitorDeliveryDispatcher _outboxDispatcher = outboxDispatcher;
    private readonly int _customerId = options.CustomerId;
