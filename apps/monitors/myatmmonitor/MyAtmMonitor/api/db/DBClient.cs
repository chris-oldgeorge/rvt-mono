...
public class DBClient : IDBClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        MonitorEntity? monitor = await context.Monitors.SingleOrDefaultAsync(row => row.Id == commit.Monitor.Id, cancellationToken) ?? throw AdapterException.Of($"CommitDustImport monitorId={commit.Monitor.Id} was not found.");
