...
public sealed class MyAtmHttpGatewayTests
{
    ...
    {
        DateTime cursor = new DateTime(2026, 7, 16, 8, 0, 0, DateTimeKind.Unspecified);
    ...
    public async Task HttpGetDeviceMeasurementPageAsync_UsesKeysetPagingAndNormalizesAFullPage()
    {
        ...
        DateTime cursor = new DateTime(2023, 9, 25, 10, 0, 0, DateTimeKind.Utc);
        ...
        MyAtmHttpGateway gateway = new MyAtmHttpGateway(httpClient.Object, devicePageSize: 100, measurementPageSize: 2, accessoryPageSize: 2);
