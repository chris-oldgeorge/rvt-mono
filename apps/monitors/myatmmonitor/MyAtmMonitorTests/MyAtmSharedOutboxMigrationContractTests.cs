...
public sealed partial class MyAtmSharedOutboxMigrationContractTests
{
    ...
    private const string AddSharedOutbox = "2026-07-15-add-monitor-delivery-outbox.postgres.sql";
    ...
    [DataRow(AddSharedOutbox, "CREATE TABLE IF NOT EXISTS", "CREATE INDEX IF NOT EXISTS")]
