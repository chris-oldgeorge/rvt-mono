...
public class FDomVtopOverflow(double fdom, double vtop, double vtopOverflow)
{
    public double Fdom { get; set; } = fdom;
    public double Vtop { get; set; } = vtop;

    [JsonPropertyName("vtopOverflow")]
    public double VtopOverflow { get; set; } = vtopOverflow;
}
