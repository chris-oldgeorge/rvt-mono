...
namespace Omnidots.Api
{
    ...
    public class OmnidotsService
    {
        ...
        public Task MonitoringAsync(CancellationToken cancellationToken = default)
        {
            ...
            return _omnidotsApi.MonitoringAsync(cancellationToken);
        }
    }
}
