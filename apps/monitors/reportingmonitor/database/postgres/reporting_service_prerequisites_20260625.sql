...
-- Major updates: 2026-06-25 added pgcrypto, hidden one-time report-rule marker, and index for rvt-reporting-new; 2026-07-31 wrapped in a transaction so a failure leaves nothing half-applied.
