...
// Major updates:
// - 2026-06-26 pending Added the recommended ISerializable attribute and private constructor pattern.
// - 2026-06-25 pending Matched Equals override parameter nullability to object.Equals.
// - 2026-06-10 pending Replaced exact floating-point zero checks with tolerance-based comparisons.
// - 2026-06-10 pending Reused complex parse regex and simplified string formatting for Sonar performance.
// - 2026-06-09 pending Renamed data-access namespaces and repository types to RVT.DataAccess/Repository.
// - 2026-06-04 pending Added regex match timeout for complex-number parsing.
...
namespace AForge.Math
{
    ...
    public struct Complex : ICloneable, ISerializable
    {
        ...
        {
            this.Re = info.GetDouble("Real");
            this.Im = info.GetDouble("Imaginary");
        }
        ...
        {
            return ApproxEqual(a, b, ZeroTolerance);
        }
        ...
        private static readonly TimeSpan _parseRegexTimeout = TimeSpan.FromMilliseconds(250);
        private static readonly Regex _parseRegex = new Regex(@"\((?<real>.*),(?<imaginary>.*)\)", RegexOptions.CultureInvariant, _parseRegexTimeout);
        ...
        public static Complex Log(Complex a)
        {
            ...
            if ((a.Re > 0.0) && IsNearlyZero(a.Im))
            {
                result.Re = System.Math.Log(a.Re);
                result.Im = 0.0;
            }
            else if (IsNearlyZero(a.Re))
            {
                if (a.Im > 0.0)
                {
        ...
        [SuppressMessage(
            ...
            Justification = "The equality operator must remain exact to stay consistent with Equals and GetHashCode; approximate callers should use ApproxEqual.")]
