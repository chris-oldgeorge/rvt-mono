...
public static class TimeSeriesProjections
{
    ...
    {
        NoiseLevel15minAvg item = new()
        {
            SerialId = entity.SerialId,
            SampleTime = entity.SampleTime,
            Laeq = entity.Laeq == null ? 0 : entity.Laeq.Value,
            Lamax = entity.Lamax == null ? 0 : entity.Lamax.Value,
            La90 = entity.La90 == null ? 0 : entity.La90.Value,
            La10 = entity.La10 == null ? 0 : entity.La10.Value,
            Lceq = entity.Lceq == null ? 0 : entity.Lceq.Value,
            Lcmax = entity.Lcmax == null ? 0 : entity.Lcmax.Value,
            Lc90 = entity.Lc90 == null ? 0 : entity.Lc90.Value,
            Lc10 = entity.Lc10 == null ? 0 : entity.Lc10.Value
        };
        return item;
    }
    ...
    public static NoiseLevel15minAvg NoiseLevelFromDay(NoiseLevel1dayAvg entity)
    {
        ...
        {
            SerialId = entity.SerialId,
            SampleTime = entity.SampleTime.GetValueOrDefault(), //Can't be null here so doesn't matter
            Laeq = entity.Laeq == null ? 0 : entity.Laeq.Value,
            Lamax = entity.Lamax == null ? 0 : entity.Lamax.Value,
            La90 = entity.La90 == null ? 0 : entity.La90.Value,
            La10 = entity.La10 == null ? 0 : entity.La10.Value,
