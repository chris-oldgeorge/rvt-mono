    ...
    public async Task AssignedScope_UsesActiveWindowForExistenceAndPagedQuery()
    {
        ...
        await factory.SeedDomainEntitiesAsync(
            ...
            new Site
            {
                ...
                CreateDate = _now.UtcDateTime.AddDays(-2),
                Contracts = []
            },
            new Site
            {
                ...
                CreateDate = _now.UtcDateTime.AddDays(-3),
                Contracts = []
            },
            new SiteUsers
            {
                ...
                SiteId = activeSiteId,
                UserId = userId,
                StartDate = _now.UtcDateTime,
                EndDate = _now.UtcDateTime
            },
            new SiteUsers
            {
                Id = Guid.NewGuid(),
