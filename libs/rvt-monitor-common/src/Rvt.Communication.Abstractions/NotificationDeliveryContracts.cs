...
public sealed record NotificationDeliveryRequest(NotificationMessageKind Kind, NotificationChannel Channel, string Destination, string MonitorName, string CallbackUrl);
